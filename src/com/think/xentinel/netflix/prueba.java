...
public class prueba {
	...
	public static void main(String[] args) {
		...
		arregloPeliculas[0].setTiempoVisto(1.0);
		arregloPeliculas[3].setTiempoVisto(.23);
		series[0].setTiempoVisto(1.45);
		series[1].setTiempoVisto(2.23);
		
		arregloPeliculas[1].setVisto(true);
		arregloPeliculas[0].setVisto(true);
		series[3].setVisto(true);
		series[0].setVisto(true);
